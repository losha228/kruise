...
func enqueueDaemonSet(q workqueue.RateLimitingInterface, ds *apps.DaemonSet) {
...
func joinDaemonSetNames(dsList []*apps.DaemonSet) string {
	var names []string
	for _, ds := range dsList {
...
func (e *podEventHandler) resolveControllerRef(namespace string, controllerRef *metav1.OwnerReference) *apps.DaemonSet {
