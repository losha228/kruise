...
func (r RealPodControl) PatchDeamonSet(namespace, name string, data []byte) error {
	_, err := r.KubeClient.AppsV1().DaemonSets(namespace).Patch(context.TODO(), name, types.StrategicMergePatchType, data, metav1.PatchOptions{})
	return err
}
